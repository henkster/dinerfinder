class MapDisplayController < ApplicationController
  ...
  def lookup_geocodes
    ...
    places = [
      {:address=>'3154 Bush Drive, Franklin, TN  37064',:description=>'Home'},
      {:address=>'4080 Columbia Pike, Franklin, TN  37064',:description=>'Winstead'}
     ]
    ...
    render :text=> 'Looked up the geocodes for '+places.length.to_s+
	    ' address and stored the result in the session . . .latitude: '+
	    places[0][:latitude].to_s+' and longitude: '+places[0][:longitude].to_s
